            ...
            <div className="grid items-center justify-items-center gap-x-4 gap-y-10 lg:grid-cols-2">
              <div className="flex items-center justify-center">
                <div className="px-2 md:px-12">
                  ...
                  <form action="" className="mt-8 space-y-4 border border-gray-200 bg-gray-100 p-6 rounded-lg">
                    ...
                    <div className={styles.inputLabelDiv}>
                      <label className={styles.inputLabel} htmlFor="phone_number">
                        Phone number
                      </label>
                      <input
                        className={styles.inputForm}
                    ...
                    <button
                      type="button"
                      className="w-50px mx-auto rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
